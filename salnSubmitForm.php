...
<body>
    ...
    <form action="salnController.php" method="POST" enctype="multipart/form-data">
        <label for="employeeName">Employee Name:</label>
        <input type="text" id="employeeName" name="employeeName" required>
        <br><br>

        <label for="salnYear">SALN Year:</label>
        <input type="number" id="salnYear" name="salnYear" required>
        <br><br>
