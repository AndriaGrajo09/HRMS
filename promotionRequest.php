...
<body>
    ...
    <form action="promotionController.php" method="POST" enctype="multipart/form-data">
        ...
        <br><br><label for="promotionReason">Reason for Promotion:</label>
        <textarea id="promotionReason" name="promotionReason" rows="4" required></textarea>
        <br><br>
        ...
        <input type="submit" value="Submit Promotion Request">
    </form>
</body>
</html>